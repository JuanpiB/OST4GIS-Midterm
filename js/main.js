...
var myStyle = function(feature) {
  ...
  if (feature.properties.Regression<=4,801.05){
    return  {fillColor: 'red'};
  }
  if(feature.properties.Regression<=5,225.68 &&
    feature.properties.Regression>=4,801.06){
    return {fillColor:'green'};
  }
  if(feature.properties.Regression<=5,898.42 &&
    feature.properties.Regression>=5,225.69){
    return{fillColor:'pink'};
  }
  if(feature.properties.Regression<=6,401.39 &&
    feature.properties.Regression>=5,898.43){
    return{fillColor:'orange'};
  }
  if(feature.properties.Regression<=7,164.33 &&
    feature.properties.Regression>=6,401.40){
...
var eachFeatureFunction = function(layer) {
  layer.on('click', function (event) {
    switch(layer.feature.properties.Regression){
      case (val <= 4,801.05):
        $('.income-level').text('Lowest Quintile- 5th Quintile');
        console.log("hello");
        break;
      case (val<=5,225.68 && val>=4,801.06):
        $('.income-level').text('4th Quintile');
        break;
      case (val<=5,898.42 && val>=5,225.69):
        $('.income-level').text('3rd Quintile');
        break;
      case (val<=6,401.39 && val>=5,898.43):
        $('.income-level').text('2nd Quintile');
        break;
      case (val<=7,164.33 && val>=6,401.40):
        $('.income-level').text('Top Quintile- 1st Quintile');
        break;
    }
...
var myFilter = function(feature) {
  if(feature.properties.Regression!=" ")
  return true;
};
